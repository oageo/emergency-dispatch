...
use crate::parse::parse_082015::return_082015;
use crate::parse::parse_082031::return_082031;
use crate::parse::parse_082058::return_082058;
use crate::parse::parse_082121::return_082121;
use crate::parse::parse_082147::return_082147;
use crate::parse::parse_082155::return_082155;
use crate::parse::parse_082163::return_082163;
use crate::parse::parse_082171::return_082171;
use crate::parse::parse_082252::return_082252;
use crate::parse::parse_082261::return_082261;
use crate::parse::parse_082309::return_082309;
use crate::parse::parse_082368::return_082368;
use crate::parse::parse_083020::return_083020;
use crate::parse::parse_083097::return_083097;
use crate::parse::parse_083101::return_083101;
use crate::parse::parse_083640::return_083640;
...
pub fn get_all() -> Result<(), Box<dyn std::error::Error>> {
    ...
    call_parser!(return_082015());
    call_parser!(return_082031());
    call_parser!(return_082058());
    call_parser!(return_082121());
    call_parser!(return_082147());
    call_parser!(return_082155());
    call_parser!(return_082163());
    call_parser!(return_082171());
    call_parser!(return_082252());
    call_parser!(return_082261());
    call_parser!(return_082309());
    call_parser!(return_082368());
    call_parser!(return_083020());
    call_parser!(return_083097());
    call_parser!(return_083101());
    call_parser!(return_083640());
